 ...
 */
public class FaceRetrofitClient {
    //超时时间
    ...
    private static class SingletonHolder {
        private static FaceRetrofitClient INSTANCE = new FaceRetrofitClient();
    }

    public static FaceRetrofitClient getInstance() {
        return SingletonHolder.INSTANCE;
    }
    private FaceRetrofitClient() {
