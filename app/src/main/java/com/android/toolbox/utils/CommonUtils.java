...
public class CommonUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = ToolBoxApplication.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) ToolBoxApplication.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
